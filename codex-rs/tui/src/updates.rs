...
// Fork: compare against this fork's releases, never the upstream openai/codex releases, so an
// upgrade prompt cannot steer a multi-account build back onto the official binary.
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/gps949/codex/releases/latest";
