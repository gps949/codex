...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/gps949/codex".cyan().underlined(),
        ...
        let content = text![
            ...
            "https://github.com/gps949/codex/releases/latest"
                .cyan()
                .underlined(),
        ];
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            "See https://github.com/gps949/codex for installation options.".to_string()
        };
        vec![
            ...
            Line::from("https://github.com/gps949/codex/releases/latest"),
        ]
    }
