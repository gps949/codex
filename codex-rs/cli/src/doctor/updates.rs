...
// Fork: doctor compares against this fork's releases instead of upstream openai/codex.
const GITHUB_LATEST_RELEASE_URL: &str = "https://api.github.com/repos/gps949/codex/releases/latest";
